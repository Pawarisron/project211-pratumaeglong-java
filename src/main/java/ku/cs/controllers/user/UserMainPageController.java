...
public class UserMainPageController {
    ...
    @FXML void handleLogoutButton(ActionEvent actionEvent){
        changePage("home");
    }
    @FXML void handleReportButton(ActionEvent actionEvent) {
        changePage("user_report_page", account);
    }
    @FXML void handleReportListButton(ActionEvent actionEvent){
        changePage("user_report_list_page",account);
    }
    @FXML void handleMyReportButton(ActionEvent actionEvent){
        changePage("user_self_report_page",account);
    }

    public static void changePage(){
        try {
            //เปลี่ยนการแสดงผลไปที่ route ที่ชื่อ user_main_page
            com.github.saacsos.FXRouter.goTo("user_main_page");
        } catch (IOException e) {
            System.err.println("ไปที่หน้า user_main_page ไม่ได้");
    ...
    public static void changePage(String gotoTarget, Account account){
        try {
            //เปลี่ยนการแสดงผลไปที่ route ที่ชื่อ user_main_page
            com.github.saacsos.FXRouter.goTo(gotoTarget,account);
        } catch (IOException e) {
            System.err.println("ไปที่หน้า"+gotoTarget +"ไม่ได้");
            System.err.println("ให้ตรวจสอบการกำหนด route");
        }
